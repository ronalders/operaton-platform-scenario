...
public class ProcessScenarioTestReportGenerator extends AbstractProcessReport<ProcessScenarioTestReportGenerator> {
  ...
  private static final String RESOURCE_PROPERTIES_FILE_NAME = "operaton-platform-scenario.properties";
  ...
  private static final String DEFAULT_REPORTS_PATH = "./target/operaton-reports/";
  ...
  static {
    ...
    // operaton-platform-scenario.properties
    ...
    if (resourcePropertiesStream != null) {
      try {
        ...
        while (properties.hasMoreElements()) {
          ...
          if (resourceProperty != null && !resourceProperty.isEmpty())
  ...
  public ProcessScenarioTestReportGenerator(
    ...
    this.featurePackageName = featurePackageName != null && !featurePackageName.isEmpty() ? featurePackageName : "";
