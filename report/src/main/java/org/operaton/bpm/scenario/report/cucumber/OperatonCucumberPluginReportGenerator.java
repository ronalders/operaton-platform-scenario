package org.operaton.bpm.scenario.report.cucumber;
 ...
 */
public class OperatonCucumberPluginReportGenerator {

  public OperatonCucumberPluginReportGenerator(TestCase testCase, String deploymentId) {
