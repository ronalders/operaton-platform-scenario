...
import static org.operaton.bpm.scenario.report.bpmn.ProcessCoverageReport.coverageActivityInstances;
import static org.operaton.bpm.scenario.report.bpmn.ProcessCoverageReport.coverageBpmnModelInstances;
...
public class ProcessScenarioReport extends AbstractProcessReport<BpmnModelInstance> {
  ...
  public BpmnModelInstance generate(String processInstanceId) {
    ...
    String processDefinitionId = activityInstances.getFirst().getProcessDefinitionId();
  ...
  protected List<HistoricActivityInstance> findActivityInstancesByProcessInstanceId(String processInstanceId) {
    ...
    if (!activityInstanceList.isEmpty()) {
      String processDefinitionKey = activityInstanceList.getFirst().getProcessDefinitionKey();
