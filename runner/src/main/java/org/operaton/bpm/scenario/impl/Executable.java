...
import org.operaton.bpm.scenario.impl.job.ContinuationExecutable;
import org.operaton.bpm.scenario.impl.waitstate.IgnoredExecutable;
...
public interface Executable<S> extends Comparable<S> {
  ...
  class Deferreds {
    ...
    static List<Executable> next(ProcessRunnerImpl runner) {
      List<Executable> e = new ArrayList<>();
