package org.operaton.bpm.scenario.impl.util;
...
public abstract class Log {
  ...
  private static final String LOGGER = "org.operaton.bpm.scenario";
  private static final ScenarioLog scenarioLog = Api.feature("org.slf4j.Logger").isSupported() ? new Slf4jLog() : new JavaLog();
