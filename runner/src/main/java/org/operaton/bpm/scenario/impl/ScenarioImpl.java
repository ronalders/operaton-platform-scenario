...
public class ScenarioImpl extends Scenario {
  ...
  public ProcessInstance instance(ProcessScenario scenario) {
    ...
    return instances.size() == 1 ? instances.getFirst() : null;
  }
  ...
  protected void init() {
    ...
    if (processEngine == null) {
      ...
      if (processEngines.size() == 1) {
        ...
        String message = processEngines.isEmpty() ? "No ProcessEngine found to be " +
  ...
  public StartableRunner toBeStartedBy() {
    return (StartableRunner) runners.getLast();
  }
