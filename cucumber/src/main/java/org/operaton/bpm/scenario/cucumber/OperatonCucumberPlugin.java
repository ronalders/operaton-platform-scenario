package org.operaton.bpm.scenario.cucumber;
 ...
 */
public class OperatonCucumberPlugin implements ConcurrentEventListener {

  protected static final Logger log = LoggerFactory.getLogger(OperatonCucumberPlugin.class.getPackage().getName());
  protected static final String configurationResource = "operaton.cfg.xml";
  ...
  protected void finish(TestCaseFinished event) {
    ...
    if (deploymentId != null) {
      ...
      try {
        ...
        Class<?> reportGeneratorClass = Class.forName("org.operaton.bpm.scenario.report.cucumber.OperatonCucumberPluginReportGenerator");
